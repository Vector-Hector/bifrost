...
replace github.com/LdDl/osm2ch v1.5.0 => github.com/Vector-Hector/osm2ch v1.5.3

require (
	github.com/LdDl/osm2ch v1.5.0
	github.com/Vector-Hector/fptf v0.0.8
...
require (
	...
	github.com/paulmach/osm v0.3.0 // indirect
